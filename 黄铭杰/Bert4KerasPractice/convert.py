...
out_file = 'E:/NLP/语言模型压缩包/CPM_LM_2.6B_TF/model.ckpt'

m0 = torch.load('E:/NLP/语言模型压缩包/CPM/CPM-large/80000/mp_rank_00_model_states.pt', map_location='cpu')
m1 = torch.load('E:/NLP/语言模型压缩包/CPM/CPM-large/80000/mp_rank_01_model_states.pt', map_location='cpu')
