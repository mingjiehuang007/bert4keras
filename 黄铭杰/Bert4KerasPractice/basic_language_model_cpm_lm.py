...
# 模型路径
config_path = 'E:/NLP/models/GPT/CPM_LM_2.6B_TF/config.json'
checkpoint_path = 'E:/NLP/models/GPT/CPM_LM_2.6B_TF/model.ckpt'
spm_path = 'E:/NLP/models/GPT/CPM_LM_2.6B_TF/chinese_vocab.model'
